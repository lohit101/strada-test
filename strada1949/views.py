...
def test(request):
    try:
        ...
        hash_string = 'V1oanB' + txnid + amount + order + first_name + email + 'ZFr9IXXdAjuVElTJDtBF9oS6wXLm4VRq'

        print('\n', hash_string , '\n')

        hash_function = hashlib.sha512(hash_string).hexdigest()
